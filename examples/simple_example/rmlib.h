...
#define SIZE_RUN_TIME_BUFFER_QUEUE		100
...
void rmlib_export_data_string(TimeStampVeredict_t * buffer_rmlib);
...
void rmlib_export_data_string(EventTimeStamp_t * buffer_rmlib);
#endif
